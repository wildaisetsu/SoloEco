	...
	public static function get_icons( $icon, $is_echo = false, $replace = false, $menu_location = 'main' ) {
		...
		if ( true === self::is_svg_icons() ) {
			switch ( $icon ) {
				...
				case 'cart':
					$output = '<svg  x="0px" y="0px" width="25px" height="25px" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path fill-rule="evenodd" clip-rule="evenodd" d="M7.75341 4.45538C8.09243 4.45538 8.36726 4.73021 8.36726 5.06923V5.88769C8.36726 6.90475 9.19174 7.72923 10.2088 7.72923C11.2258 7.72923 12.0503 6.90475 12.0503 5.88769V5.06923C12.0503 4.73021 12.3252 4.45539 12.6642 4.45539C13.0032 4.45539 13.278 4.73021 13.278 5.06923V5.88769C13.278 7.58278 11.9039 8.95692 10.2088 8.95692C8.5137 8.95692 7.13956 7.58278 7.13956 5.88769V5.06923C7.13956 4.73021 7.41439 4.45538 7.75341 4.45538Z" fill="#141718"/>
					<path fill-rule="evenodd" clip-rule="evenodd" d="M3.41796 5.24856C3.73039 3.37396 5.3523 2 7.25276 2H13.1645C15.0649 2 16.6869 3.37396 16.9993 5.24856L18.3634 13.4332C18.7583 15.8028 16.931 17.96 14.5286 17.96H5.88865C3.4863 17.96 1.65891 15.8028 2.05386 13.4332L3.41796 5.24856ZM7.25276 3.22769C5.95245 3.22769 4.84272 4.16777 4.62895 5.45039L3.26485 13.635C2.99462 15.2564 4.24494 16.7323 5.88865 16.7323H14.5286C16.1723 16.7323 17.4226 15.2564 17.1524 13.635L15.7883 5.45039C15.5745 4.16777 14.4648 3.22769 13.1645 3.22769H7.25276Z" fill="#141718"/>
					</svg>';
					break;
